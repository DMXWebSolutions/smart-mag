...
<div class="main wrap cf">
	<div class="row">
		...
		<?php if (is_tag()): ?>
			...
			<h2 class="main-heading"><?php printf(__('Navegação: %s', 'bunyad'), '<strong>' . single_tag_title( '', false ) . '</strong>'); ?></h2>
		...
		<?php elseif (is_category()): // category page ?>
			...
			<h2 class="main-heading"><?php printf(__('Navegação: %s', 'bunyad'), '<strong>' . single_cat_title('', false) . '</strong>'); ?></h2>
		...
		<?php elseif (is_tax()): // custom taxonomies ?>
			...
			<h2 class="main-heading"><?php printf(__('Navegação: %s', 'bunyad'), '<strong>' . single_term_title('', false) . '</strong>'); ?></h2>
		...
		<?php elseif (is_search()): // search page ?>
			...
			<h2 class="main-heading"><?php printf(__('Resultado da Pesquisa: %s (%d)', 'bunyad'),  get_search_query(), $results); ?></h2>

		<?php elseif (is_archive()): ?>
			<h2 class="main-heading"><?php

			if (is_day()):
				printf(__('Arquivos diários: %s', 'bunyad'), '<strong>' . get_the_date() . '</strong>');
			elseif (is_month()):
				printf(__('Arquivos Mensais: %s', 'bunyad'), '<strong>' . get_the_date('F, Y') . '</strong>');
			elseif (is_year()):
				printf(__('Arquivos anuais: %s', 'bunyad'), '<strong>' . get_the_date('Y') . '</strong>');
			endif;
